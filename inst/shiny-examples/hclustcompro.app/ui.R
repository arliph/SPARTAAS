...
ui <- fluidPage(useShinyjs(),style="padding-top: 130px;",
  ...
  absolutePanel(class = "panel panel-default",
    ...
    fixed = TRUE,
    h2("hclustcompro: A chronological hierarchical agglomerative clustering compromoised method"),
    div(span(strong("SPARTAAS | hclustcompro")),span("v0.9.19-5 ",style ="font-size:14px;"))
  ),
  #footer
              ...
              tabsetPanel(id = "tabsetperso",type="tabs",
                      tabPanel(id="tab11","Overview",
                               ...
                               mainPanel(style = 'max-width:1000px;',
                                         ...
                                         HTML("<p>hclustcompro is a hierarchical ascending classification (HAC)
...
We have generalized this representation for other contingency data with hclustcompro object.</p>
